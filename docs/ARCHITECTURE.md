...
| Wiki canvas | `wiki_roots_list`, `wiki_root_create`, `wiki_root_rename`, `wiki_root_remove`, `wiki_tree_get`, `wiki_folder_create`, `wiki_folder_rename`, `wiki_folder_move`, `wiki_folder_delete`, `wiki_page_create`, `wiki_page_read`, `wiki_page_update`, `wiki_page_rename`, `wiki_page_move`, `wiki_page_delete`, `wiki_page_patch_selection`, `wiki_page_revisions_list`, `wiki_page_revision_restore`, `wiki_search` | Local markdown-based wiki surface |
