...
public class SearchPipelineGoldenTests
{
    ...
    // "News_ConversationalGreeting_DoesNotPollutSearchQuery" (legacy
    // AgentOrchestrator integration test) removed with the orchestrator.
    // Underlying query-noise-filtering is still covered by the
    // QueryBuilder-direct test below + QueryBuilder unit tests.
