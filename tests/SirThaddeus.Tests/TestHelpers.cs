...
internal sealed class FakeMcpClient : IMcpToolClient
{
    ...
    [
        ...
        MakeTool("file_list",          "Lists files in a directory",
                 """{"type":"object","properties":{"path":{"type":"string"}},"required":["path"]}"""),
        MakeTool("file_write",         "Writes exact UTF-8 content and returns a verified receipt",
                 """{"type":"object","properties":{"path":{"type":"string"},"content":{"type":"string"}},"required":["path","content"]}"""),
        MakeTool("file_replace",       "Replaces one exact unique text span and returns a verified receipt",
