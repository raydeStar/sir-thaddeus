...
public static class ToolCapabilityRegistry
{
    private static readonly IReadOnlyDictionary<string, ToolCapability> CapabilityByToolName =
        new Dictionary<string, ToolCapability>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["FileWrite"] = ToolCapability.FileWrite,
            ["file_replace"] = ToolCapability.FileWrite,
            ["FileReplace"] = ToolCapability.FileWrite,
            ...
            ["wiki_page_create_by_name"] = ToolCapability.WikiWrite,
            ["WikiPageCreateByName"] = ToolCapability.WikiWrite,
            ["wiki_page_update"] = ToolCapability.WikiWrite,
            ["WikiPageUpdate"] = ToolCapability.WikiWrite,
            ["wiki_page_update_by_name"] = ToolCapability.WikiWrite,
            ["WikiPageUpdateByName"] = ToolCapability.WikiWrite,
            ["wiki_page_rename"] = ToolCapability.WikiWrite,
            ["WikiPageRename"] = ToolCapability.WikiWrite,
            ["wiki_page_rename_by_name"] = ToolCapability.WikiWrite,
            ["WikiPageRenameByName"] = ToolCapability.WikiWrite,
            ...
            ["wiki_page_delete_by_name"] = ToolCapability.WikiWrite,
            ["WikiPageDeleteByName"] = ToolCapability.WikiWrite,
            ["wiki_page_patch_selection"] = ToolCapability.WikiWrite,
            ["WikiPagePatchSelection"] = ToolCapability.WikiWrite,
            ["wiki_page_patch_selection_by_name"] = ToolCapability.WikiWrite,
            ["WikiPagePatchSelectionByName"] = ToolCapability.WikiWrite,
