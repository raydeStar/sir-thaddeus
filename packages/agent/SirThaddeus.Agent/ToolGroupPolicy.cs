...
public static class ToolGroupPolicy
{
        ...
        new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["wiki_page_create_by_name"] = "files",
        ["wiki_page_update"] = "files",
        ["wiki_page_update_by_name"] = "files",
        ["wiki_page_rename"] = "files",
        ["wiki_page_rename_by_name"] = "files",
        ["wiki_page_move"] = "files",
        ["wiki_page_delete"] = "files",
        ["wiki_page_delete_by_name"] = "files",
        ["wiki_page_patch_selection"] = "files",
        ["wiki_page_patch_selection_by_name"] = "files",
