...
public sealed partial class AgentOrchestrator
{
        ...
        IReadOnlyList<ToolCallRecord>? toolCallsMade = null)
    {
        ...
        var normalizedText = ExplicitWebNoResultsContractNormalizer.TryBuildResponse(
            userMessage,
            relevantToolCalls);
        normalizedText ??= ExplicitWebNoResultsContractNormalizer.TryBuildResponseFromFailureText(
            userMessage,
            response.Text);
