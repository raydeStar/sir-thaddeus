import type { ModuleManifest } from "./coreContracts.js";

export const healthPackManifest: ModuleManifest = {
  id: "com.thaddeus.health",
  name: "Health Pack",
  version: "0.1.0",
  description:
    "Adds biometrics, health snapshots, baselines, similar-day lookup, manual check-ins, and morning strategy briefs.",
  permissions: {
    externalAccounts: [
      {
