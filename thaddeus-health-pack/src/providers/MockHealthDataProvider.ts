...
import { HealthProvider, HealthProviderStatus } from "./HealthProvider.js";

export class MockHealthDataProvider implements HealthProvider {
...
export async function buildSeededMockHistory(
  ...
  for (let offset = days; offset >= 1; offset -= 1) {
    ...
    snapshots.push(await provider.getDailySnapshot(date) as DailyHealthSnapshot);
  }
