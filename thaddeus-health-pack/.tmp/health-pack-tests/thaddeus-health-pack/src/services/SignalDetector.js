export class SignalDetector {
    ...
    classifyDay(signals, snapshot, baseline) {
        ...
        if (snapshot.sleep?.durationMinutes !== undefined &&
...
function signal(flag, label, severity, confidence, actual, baseline, explanation) {
